    ...
    <div className={`${geistSans.className} ${geistMono.className} font-sans`}>
      ...
      <div class="wrapper" className='w-full flex justify-space-between'>
        ...
        <div className='mb-5 text-pink-600 flex flex-row'>
            <Link href="/2" className="flex mb-2 hover:text-pink-400 duration-300">＜前年へ</Link>
            <Link href="/4" className="flex ml-30 md:ml-75 lg:ml-130 hover:text-pink-400 duration-300">次年へ＞</Link>
        </div>
        <h1 className="text-3xl font-bold md:text-5xl flex flex-col mb-3">第3回定期演奏会</h1>
        <Table border="1" cellpadding="2" className='flex flex-col border border-slate-500'>
            ...
            <Link href="/2" className="flex mb-2 hover:text-pink-400 duration-300">＜前の年の演奏会</Link>
              <Link href="#top" className="flex mb-2 md:ml-10 hover:text-pink-400 duration-300">↑ページトップ</Link>
              <Link href="/4" className="flex md:ml-10 hover:text-pink-400 duration-300">次の年の演奏会＞</Link>
            </div>
        </main>
      </div>
      <footer>
