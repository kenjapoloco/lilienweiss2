      ...
      <div class="wrapper" className='w-full flex justify-space-between'>
        ...
        <main class="main" className='container items-center text-center flex flex-col mr-5 ml-5 mt-40'>
          <div className='mb-5 text-pink-600 flex flex-row'>
            <Link href="/9" className="flex mb-2 hover:text-pink-400 duration-300">＜前年へ</Link>
            <Link href="/11" className="flex ml-30 md:ml-75 lg:ml-130 hover:text-pink-400 duration-300">次年へ＞</Link>
          </div>
          <h1 className="text-3xl font-bold md:text-5xl flex flex-col mb-3">第10回定期演奏会</h1>
          ...
          <div className='mb-10 text-pink-600 flex md:flex-row flex-col mt-5'>
            <Link href="/9" className="flex mb-2 hover:text-pink-400 duration-300">＜前の年の演奏会</Link>
            <Link href="#top" className="flex mb-2 md:ml-10 hover:text-pink-400 duration-300">↑ページトップ</Link>
            <Link href="/11" className="flex md:ml-10 hover:text-pink-400 duration-300">次の年の演奏会＞</Link>
          </div>
        </main>
      </div>
      <footer>
