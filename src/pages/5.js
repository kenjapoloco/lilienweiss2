    ...
    <div className={`${geistSans.className} ${geistMono.className} font-sans`}>
      ...
      <div class="wrapper" className='w-full flex justify-space-between'>
        ...
        <div className='mb-5 text-pink-600 flex flex-row'>
            <a href="/4" className="flex mb-2 hover:text-pink-400 duration-300">＜前年へ</a>
              <a href="/6" className="flex ml-30 md:ml-75 lg:ml-130 hover:text-pink-400 duration-300">次年へ＞</a>
            </div>
          ...
          <Table border="1" cellpadding="2" className='flex flex-col border border-slate-500'>
            ...
            <a href="/4" className="flex mb-2 hover:text-pink-400 duration-300">＜前の年の演奏会</a>
              <a href="#top" className="flex mb-2 md:ml-10 hover:text-pink-400 duration-300">↑ページトップ</a>
              <a href="/6" className="flex md:ml-10 hover:text-pink-400 duration-300">次の年の演奏会＞</a>
            </div>
          </main>
        </div>
        <footer>
